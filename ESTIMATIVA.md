...
História 1: Infraestrutura e configuração de ambiente - (4h)
Criação de containers, Modelagem do Banco, Setup de ambientes front e backend
- [SETUP] Criar repositório no github e definir estrutura do projeto
- [SETUP] Criar container e modelar banco de dados / migration
- [SETUP] Criar container e ambiente para backend com node + express
- [SETUP] Criar container e ambiente para frontend com vue + vuetify

História 2: Importação de CSV - (6h)
Upload e Processamento de CSV com validação/sanitização, persistência em banco
- [FRONT] Desenvolver tela/componente "drag & drop"
...
História 4: Exportação de CSV - (4h)
